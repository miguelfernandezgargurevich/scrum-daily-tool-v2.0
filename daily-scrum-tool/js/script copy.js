...
btnMenu.addEventListener('click', mostarAgregar);
...
var arrayTrovadores2 = ["Harry","Billy","Mariana","Baudy","Marco","Jorge E","Julio","Miguel","Jesús","Jhony","Anthony","Jorge M"];
var arrayTrovadores = ["Harry","Billy"];
...
function viewScreenshot(){
  ...
  var panelScreenshot = document.getElementById("panelScreenshot"); 
  panelScreenshot.style.display = panelScreenshot.style.display === 'none' ? '' : 'none';
...
function finalizar(){
  ...
  if (result.length>0){
      ...
      result = minutes + ":" + seconds;  // 2:41:30
  ...
  lblTiempoFinal.innerHTML = "El Tiempo total del daily fue de " + result;
...
function stopCapture(evt) {
  ...
  //videoElem.style.display = videoElem.style.display ='none';
