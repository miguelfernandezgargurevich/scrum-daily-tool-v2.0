...
function obtenerDimensionesScreen(){
  ...
  console.log("Device Screen: width: " + screenWidth + ", height: " + screenHeight + ".")
...
function changeBg(){
  //examinar y setear
  var panelChangeBg = document.getElementById("panelChangeBg");
  ...
  if (nombres.length>0){
    ...
    if (objSelect !== null)
    {
      ...
      setTimeout(() => {  
        ...
        document.getElementById("modalContent").style.backgroundImage = "url(./assets/images/confetti-large.gif)"
        $('#exampleModal').modal('show'); // abrir
